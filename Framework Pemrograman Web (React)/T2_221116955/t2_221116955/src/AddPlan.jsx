...
export default function AddPlan({addPlanFunction}){
            ...
            <div className="container-fluid">
                <div className="row m-2">
                    <div className="col-8 m-8">
                        <input type="text" name="plan-name" id="" style={{width:"400px", height:"35px"}}onChange={handleNameChange}/ >
                    </div>
                    <div className="col">
                ...
                <div className="row m-2">
                    <div className="col-2 d-flex">
                        ...
                        <select name="diff" className="m-2 p-1" id="" style={{height:"35px"}} onChange={handleDifficultyChange}>
                ...
                <div className="row m-2">
                    <div className="col-10 d-flex">
                        ...
                        <input className="m-2" type="text" name="durationMin" placeholder="10" id="" style={{height:"25px", width:"40px"}} onChange={handleDurationMinChange}/>
                        <p className="m-2"> to </p>
                        <input className="m-2" type="text" name="durationMax" placeholder="15" id="" style={{height:"25px", width:"40px"}} onChange={handleDurationMaxChange}/>
